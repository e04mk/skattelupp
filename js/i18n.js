const I18N = {
  sv: {
    ...
    regionUnifiedNote: "I den här regionen är kommun och region samma huvudman — regionens verksamhet finansieras direkt av din kommunalskatt ovan, i stället för en separat regionskatt.",
  ...
  en: {
    ...
    regionUnifiedNote: "In this region, the municipality and the region are the same authority — regional services are funded directly by your municipal tax above, instead of a separate regional tax.",
